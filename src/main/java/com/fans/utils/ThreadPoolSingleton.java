...
public class ThreadPoolSingleton {
    ...
    public ThreadPoolExecutor getThreadPool(int corePoolSize, int maximumPoolSize) {
        threadPoolExecutor.setCorePoolSize(corePoolSize);
        threadPoolExecutor.setMaximumPoolSize(maximumPoolSize);
        return threadPoolExecutor;
    }

    public ThreadPoolExecutor getThreadPool(long keepAliveTime, TimeUnit timeUnit) {
        threadPoolExecutor.setKeepAliveTime(keepAliveTime, timeUnit);
        return threadPoolExecutor;
    }

    public ThreadPoolExecutor getThreadPool(int corePoolSize, long keepAliveTime, TimeUnit timeUnit) {
        threadPoolExecutor.setCorePoolSize(corePoolSize);
        threadPoolExecutor.setKeepAliveTime(keepAliveTime, timeUnit);
        return threadPoolExecutor;
    }

    public ThreadPoolExecutor getThreadPool(int corePoolSize, int maximumPoolSize, long keepAliveTime, TimeUnit timeUnit) {
        threadPoolExecutor.setCorePoolSize(corePoolSize);
        threadPoolExecutor.setKeepAliveTime(keepAliveTime, timeUnit);
        threadPoolExecutor.setMaximumPoolSize(maximumPoolSize);
        return threadPoolExecutor;
    ...
    public ThreadPoolExecutor getThreadPool(ThreadFactory threadFactory) {
        threadPoolExecutor.setThreadFactory(threadFactory);
        return threadPoolExecutor;
    }

    public ThreadPoolExecutor getThreadPool(RejectedExecutionHandler rejectedExecutionHandler) {
        threadPoolExecutor.setRejectedExecutionHandler(rejectedExecutionHandler);
        return threadPoolExecutor;
    }

    public ThreadPoolExecutor getThreadPool(int corePoolSize, RejectedExecutionHandler rejectedExecutionHandler) {
        threadPoolExecutor.setCorePoolSize(corePoolSize);
        threadPoolExecutor.setRejectedExecutionHandler(rejectedExecutionHandler);
        return threadPoolExecutor;
    }

    public ThreadPoolExecutor getThreadPool(int corePoolSize, int maximumPoolSize, RejectedExecutionHandler rejectedExecutionHandler) {
        threadPoolExecutor.setCorePoolSize(corePoolSize);
        threadPoolExecutor.setMaximumPoolSize(maximumPoolSize);
        threadPoolExecutor.setRejectedExecutionHandler(rejectedExecutionHandler);
        return threadPoolExecutor;
    ...
    public ThreadPoolExecutor getThreadPool(int corePoolSize, long keepAliveTime, TimeUnit timeUnit, RejectedExecutionHandler rejectedExecutionHandler) {
        threadPoolExecutor.setCorePoolSize(corePoolSize);
        threadPoolExecutor.setKeepAliveTime(keepAliveTime, timeUnit);
        threadPoolExecutor.setRejectedExecutionHandler(rejectedExecutionHandler);
        return threadPoolExecutor;
